...
require '../antlr4/CharStreams'
require '../test/MODLParserTestListener'
...
testStrings.each do |str|
  lexer = MODL::MODLLexer.new(CharStreams.fromString(str, "Test String"))
  ...
  parsed = parser.modl()
  parsed.enterRule(listener)
  parsed.exitRule(listener)
end