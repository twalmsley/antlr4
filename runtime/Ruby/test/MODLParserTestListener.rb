...
class MODLParserTestListener < MODL::MODLParserBaseListener
  ...
  def enterModl_structure(ctx)
    ...
    ctx.modl_top_level_conditional.enterRule(self) if ctx.modl_top_level_conditional != nil
  ...
  def enterModl_map(ctx)
    ctx.modl_map_item.each {|i| i.enterRule(self)}
  end
  ...
  def enterModl_array(ctx)
    ctx.modl_array_item.each {|i| i.enterRule(self)}
    ctx.modl_nb_array.each {|i| i.enterRule(self)}
  end
  ...
  def enterModl_value_item(ctx)
    ctx.modl_value.enterRule(self) if ctx.modl_value != nil
    ctx.modl_value_conditional.enterRule(self) if ctx.modl_value_conditional != nil
  end
  ...
  def enterModl_top_level_conditional(ctx)
    ctx.modl_condition_test.each {|i| i.enterRule(self)}
    ctx.modl_top_level_conditional_return.each {|i| i.enterRule(self)}
  end
  ...
  def enterModl_map_item(ctx)
    ctx.modl_pair.enterRule(self) if ctx.modl_pair != nil
    ctx.modl_map_conditional.enterRule(self) if ctx.modl_map_conditional != nil
  end
  ...
  def enterModl_array_conditional(ctx)
    ctx.modl_condition_test.each {|i| i.enterRule(self)}
    ctx.modl_array_conditional_return.each {|i| i.enterRule(self)}
  end
  ...
  def enterModl_array_item(ctx)
    ctx.modl_array_value_item.enterRule(self) if ctx.modl_array_value_item != nil
    ctx.modl_array_conditional.enterRule(self) if ctx.modl_array_conditional != nil
  end
  ...
  def enterModl_value_conditional(ctx)
    ctx.modl_condition_test.each {|i| i.enterRule(self)}
    ctx.modl_value_conditional_return.each {|i| i.enterRule(self)}
  end
  ...
  def enterModl_value_conditional_return(ctx)
    ctx.modl_value_item.each {|i| i.enterRule(self)}
  end
  ...
  def enterModl_condition_test(ctx)
    ctx.modl_condition.each {|i| i.enterRule(self)}
    ctx.modl_condition_group.each {|i| i.enterRule(self)}
  end
  ...
  def enterModl_condition(ctx)
    ctx.modl_value.each {|i| i.enterRule(self)}
    ctx.modl_operator.enterRule(self) if ctx.modl_operator != nil
  end
  ...
  def enterModl_value(ctx)
    ctx.modl_map.enterRule(self) if ctx.modl_map != nil
    ctx.modl_array.enterRule(self) if ctx.modl_array != nil
    ctx.modl_nb_array.enterRule(self) if ctx.modl_nb_array != nil
    ctx.modl_pair.enterRule(self) if ctx.modl_pair != nil
    ctx.modl_map.enterRule(self) if ctx.modl_map != nil
    ctx.modl_map.enterRule(self) if ctx.modl_map != nil
