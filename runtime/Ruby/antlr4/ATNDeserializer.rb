require 'ostruct'
require '../antlr4/ATNDeserializationOptions'
require '../antlr4/Uuid'
require '../antlr4/ATNType'
require '../antlr4/ATNState'
require '../antlr4/ATN'
require '../antlr4/BlockStartState'
require '../antlr4/Transition'

require '../antlr4/BasicState'
require '../antlr4/RuleStartState'
require '../antlr4/BasicBlockStartState'
require '../antlr4/PlusBlockStartState'
require '../antlr4/StarBlockStartState'
require '../antlr4/TokensStartState'
require '../antlr4/RuleStopState'
require '../antlr4/BlockEndState'
require '../antlr4/StarLoopbackState'
require '../antlr4/StarLoopEntryState'
require '../antlr4/PlusLoopbackState'
require '../antlr4/LoopEndState'

require '../antlr4/EpsilonTransition'
require '../antlr4/RangeTransition'
require '../antlr4/RangeTransition'
require '../antlr4/RuleTransition'
require '../antlr4/PredicateTransition'
require '../antlr4/PrecedencePredicateTransition'
require '../antlr4/AtomTransition'
require '../antlr4/ActionTransition'
