...
class ATNSerializer 
	...
	def self.getSerializedAsString(ATN atn) 
	...
	def self.getSerializedAsChars(ATN atn) 
		return Utils.toCharArray(getSerialized(atn))
	end

	def self.getDecoded(ATN atn, List<String> tokenNames) 
